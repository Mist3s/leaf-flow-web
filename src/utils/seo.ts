...
export const SEO_PAGES = {
  ...
  notfound: {
    title: 'Страница не найдена — Zavarka39 | Китайский чай в Калининграде',
    description: 'Запрашиваемая страница не найдена. Перейдите в каталог китайского чая Zavarka39 — пуэр, улун, зелёный, белый чай с доставкой по Калининграду.',
    canonical: '/404/',
  },
} as const;
